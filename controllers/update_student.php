...
if (isset($_POST['update_profile'])) {
    ...
    if (is_uploaded_file($uploadedFile)) {
        if (in_array($fileExtension, $allowedExtensions)) {
           ...
           $query = mysqli_query($conn,"UPDATE students SET email='$email', name='$name', password='$password', picture='$fileName' WHERE student_id = '$student_id'")or die(mysqli_error()); 
        ...
        $query = mysqli_query($conn,"UPDATE students SET email='$email', name='$name', password='$password' WHERE student_id = '$student_id'")or die(mysqli_error()); 
