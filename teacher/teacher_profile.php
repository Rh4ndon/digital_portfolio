        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="../assets/img/<?php echo $row_teacher['picture']; ?>" style="width: 50%;" alt="Profile" class="rounded-circle">
              <h2><?php echo $row_teacher['name']; ?></h2>
              <h3><?php echo $row_teacher['subject']; ?></h3>
              <h4><?php echo $row_teacher['email']; ?></h4>
