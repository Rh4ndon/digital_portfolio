            ...
            <form method="POST" action="../controllers/update_profile.php" enctype="multipart/form-data">
              <div class="row mb-4">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="name" value="<?php echo $row_teacher['name']; ?>" class="form-control">
                    <input type="hidden" name="teacher_id" value="<?php echo $row_teacher['teacher_id']; ?>" required>
                  </div>
                </div>
               <div class="row mb-4">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                  <div class="col-sm-10">
                    <input type="email" name="email" value="<?php echo $row_teacher['email']; ?>" class="form-control" required>
                  </div>
                </div>
                <div class="row mb-4">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Password</label>
                  <div class="col-sm-10">
                    <input type="password" name="password" value="<?php echo $row_teacher['password']; ?>" class="form-control" required>
                  </div>
                </div>
